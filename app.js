...
const CONTENT = {
  ...
  g8t3s1: {
    shortIntro: 'Деленето на отсечка в дадено отношение е основа за много построения и доказателства. Точка дели отсечка в отношение m:n, ако я разделя на две части с това отношение.',
    definitions: [
      { term: 'Делене в отношение', def: 'Точка C дели отсечката AB в отношение <katex>m:n</katex>, ако <katex>AC:CB = m:n</katex>.' }
    ],
    formulas: [
      { label: 'Дължина на частите', tex: 'AC = \\dfrac{m}{m+n} \\cdot AB, \\quad CB = \\dfrac{n}{m+n} \\cdot AB' }
    ],
    algorithm: [
      'Запиши даденото отношение m:n.',
      'Сумирай частите: m + n.',
      'Всяка част е съответната дроб от цялата отсечка.'
    ],
    example: {
      problem: 'Точка C дели отсечка AB = 20 cm в отношение 2:3. Намери AC и CB.',
      solution: 'Сума на частите: 2 + 3 = 5.<br><katex>AC = \\dfrac{2}{5} \\cdot 20 = 8</katex> cm.<br><katex>CB = \\dfrac{3}{5} \\cdot 20 = 12</katex> cm.<br>Проверка: 8 + 12 = 20 ✓'
    },
    mistakes: [
      { label: 'Грешен знаменател', text: 'Знаменателят е сборът m + n, а не само едно от числата.' }
    ],
    miniCheck: [
      {
        q: 'Точка дели отсечка 15 cm в отношение 1:2. Колко е по-малката част?',
        options: ['5 cm', '7.5 cm', '10 cm'],
        correct: 0,
        feedback: '1/(1+2) · 15 = 1/3 · 15 = 5 cm.'
      }
    ],
    remember: 'Отсечка в отношение m:n: всяка част е <katex>\\dfrac{m}{m+n}</katex> или <katex>\\dfrac{n}{m+n}</katex> от цялото.'
  },
  ...
  g8t5s6: {
    ...
    drawing: { svg: `<svg viewBox="0 0 380 140" xmlns="http://www.w3.org/2000/svg" style="max-width:380px;">
  <!-- D>0 -->
  <g>
    <line x1="5" y1="70" x2="120" y2="70" stroke="#94a3b8" stroke-width="1"/>
    <path d="M 7.2 50.6 L 16.0 70.0 L 30.7 94.4 L 51.2 112.2 L 60.0 114.0 L 68.8 112.2 L 89.3 94.4 L 104.0 70.0 L 112.8 50.6" fill="none" stroke="#4f6ef7" stroke-width="2.2"/>
    <circle cx="38.5" cy="70" r="3.5" fill="#e84393"/>
    <circle cx="81.5" cy="70" r="3.5" fill="#e84393"/>
    <text x="60" y="20" font-size="13" fill="#1a1f2e" text-anchor="middle" font-weight="600">D &gt; 0</text>
    <text x="60" y="134" font-size="11" fill="#64748b" text-anchor="middle">2 корена</text>
  </g>
  <!-- D=0 -->
  <g transform="translate(130,0)">
    <line x1="5" y1="110" x2="120" y2="110" stroke="#94a3b8" stroke-width="1"/>
    <path d="M 7.2 46.6 L 16.0 66.0 L 30.7 90.4 L 51.2 108.2 L 60.0 110.0 L 68.8 108.2 L 89.3 90.4 L 104.0 66.0 L 112.8 46.6" fill="none" stroke="#4f6ef7" stroke-width="2.2"/>
    <circle cx="60" cy="110" r="3.5" fill="#e84393"/>
    <text x="60" y="20" font-size="13" fill="#1a1f2e" text-anchor="middle" font-weight="600">D = 0</text>
    <text x="60" y="134" font-size="11" fill="#64748b" text-anchor="middle">1 двоен корен</text>
  </g>
  <!-- D<0 -->
  <g transform="translate(260,0)">
    <line x1="5" y1="110" x2="120" y2="110" stroke="#94a3b8" stroke-width="1"/>
    <path d="M 7.2 24.6 L 16.0 44.0 L 30.7 68.4 L 51.2 86.2 L 60.0 88.0 L 68.8 86.2 L 89.3 68.4 L 104.0 44.0 L 112.8 24.6" fill="none" stroke="#4f6ef7" stroke-width="2.2"/>
    <text x="60" y="20" font-size="13" fill="#1a1f2e" text-anchor="middle" font-weight="600">D &lt; 0</text>
    <text x="60" y="134" font-size="11" fill="#64748b" text-anchor="middle">няма реални</text>
  </g>
</svg>`, caption: 'Геометрична интерпретация: пресечни точки на параболата с оста Ox.' },
  ...
  g8t6s7: {
    ...
    drawing: { svg: `<svg viewBox="0 0 320 230" xmlns="http://www.w3.org/2000/svg" style="max-width:320px;">
  <circle cx="160" cy="115" r="90" fill="#eef1fe" stroke="#4f6ef7" stroke-width="2"/>
  <line x1="70" y1="115" x2="250" y2="115" stroke="#10b981" stroke-width="2"/>
  <line x1="70" y1="115" x2="160" y2="25" stroke="#e84393" stroke-width="2"/>
  <line x1="250" y1="115" x2="160" y2="25" stroke="#e84393" stroke-width="2"/>
  <rect x="148" y="37" width="14" height="14" fill="none" stroke="#64748b" stroke-width="1.2" transform="rotate(45 160 40)"/>
  <circle cx="160" cy="115" r="3" fill="#1a1f2e"/>
  <circle cx="70" cy="115" r="3" fill="#1a1f2e"/>
  <circle cx="250" cy="115" r="3" fill="#1a1f2e"/>
  <circle cx="160" cy="25" r="3" fill="#1a1f2e"/>
  <text x="54" y="120" font-size="13" fill="#64748b">A</text>
  <text x="254" y="120" font-size="13" fill="#64748b">B</text>
  <text x="152" y="20" font-size="13" fill="#64748b">C</text>
  <text x="150" y="133" font-size="11" fill="#10b981" font-weight="600">диаметър</text>
  <text x="168" y="62" font-size="11" fill="#e84393" font-weight="600">90°</text>
</svg>`, caption: 'Периферен ъгъл върху диаметър е винаги прав (90°).' },
    algorithm: [
  ...
  g8t6s10: {
    shortIntro: 'Две окръжности може да не се пресичат, да се допират (отвътре или отвън) или да се пресичат в две точки — в зависимост от разстоянието между центровете.',
    definitions: [
      { term: 'Положение на две окръжности', def: 'Определя се от разстоянието d между центровете спрямо сбора и разликата на радиусите.' }
    ],
    formulas: [
      { label: 'Външно допиране', tex: 'd = r_1 + r_2' },
      { label: 'Вътрешно допиране', tex: 'd = |r_1 - r_2|' },
      { label: 'Пресичане', tex: '|r_1 - r_2| < d < r_1 + r_2' }
    ],
    drawing: { svg: `<svg viewBox="0 0 340 180" xmlns="http://www.w3.org/2000/svg" style="max-width:340px;">
  <circle cx="70" cy="90" r="45" fill="none" stroke="#4f6ef7" stroke-width="1.8"/>
  <circle cx="135" cy="90" r="45" fill="none" stroke="#e84393" stroke-width="1.8"/>
  <text x="100" y="160" font-size="10" fill="#64748b" text-anchor="middle">пресичат се (2 т.)</text>
  <circle cx="240" cy="90" r="45" fill="none" stroke="#4f6ef7" stroke-width="1.8"/>
  <circle cx="300" cy="90" r="20" fill="none" stroke="#e84393" stroke-width="1.8"/>
  <text x="265" y="160" font-size="10" fill="#64748b" text-anchor="middle">допират се (1 т.)</text>
</svg>`, caption: 'Две окръжности: пресичане (2 точки) и допиране (1 точка).' },
    algorithm: [
      'Намери разстоянието d между центровете.',
      'Сравни d със сбора и разликата на радиусите.',
      'Определи положението.'
    ],
    example: {
    ...
    remember: 'd = r₁+r₂ → външно допиране | d = |r₁−r₂| → вътрешно | между тях → пресичане.'
  },
  ...
  g8t8s1: {
    shortIntro: 'Около всеки триъгълник може да се опише окръжност, минаваща през трите му върха. Центърът ѝ е пресечната точка на симетралите на страните.',
    definitions: [
  ...
  <text x="142" y="54" font-size="13" fill="#64748b">C</text>
  <text x="168" y="172" font-size="12" fill="#10b981" font-weight="600">O</text>
  <text x="186" y="252" font-size="11" fill="#4f6ef7" font-weight="600">описана</text>
</svg>`, caption: 'Описана окръжност: център O (от симетралите), минава през A, B, C.' },
    algorithm: [
    ...
    example: {
      problem: 'Защо центърът на описаната окръжност е равноотдалечен от върховете?',
      solution: 'Защото лежи на симетралите — всяка точка от симетралата на отсечка е равноотдалечена от краищата ѝ. Затова OA = OB = OC = R.'
    },
    mistakes: [
    ...
    remember: 'Описана окръжност: център = пресечна точка на симетралите, равноотдалечен от върховете (OA=OB=OC=R).'
  },

  // --- Вписана окръжност в триъгълник ---
  g8t8s2: {
    shortIntro: 'Във всеки триъгълник може да се впише окръжност, която докосва трите му страни. Центърът ѝ е пресечната точка на ъглополовящите.',
    definitions: [
    ...
    formulas: [
      ...
      { label: 'Означения', tex: 's = \\dfrac{a+b+c}{2} \\;(\\text{полупериметър})' }
    ],
    drawing: { svg: `<svg viewBox="0 0 320 280" xmlns="http://www.w3.org/2000/svg" style="max-width:320px;">
  <polygon points="60,210 260,210 150,60" fill="#eef1fe" stroke="#e84393" stroke-width="2"/>
  <circle cx="154" cy="157" r="53.5" fill="none" stroke="#4f6ef7" stroke-width="2"/>
  ...
  <text x="264" y="226" font-size="13" fill="#64748b">B</text>
  <text x="142" y="54" font-size="13" fill="#64748b">C</text>
  <text x="160" y="161" font-size="12" fill="#10b981" font-weight="600">I</text>
  <text x="116" y="135" font-size="11" fill="#4f6ef7" font-weight="600">вписана</text>
</svg>`, caption: 'Вписана окръжност: център I (от ъглополовящите), докосва трите страни.' },
    algorithm: [
    ...
    remember: 'Вписана окръжност: център = пресечна точка на ъглополовящите, <katex>r = \\dfrac{S}{s}</katex>.'
  },

  // --- Ортоцентър ---
  g8t8s3: {
    shortIntro: 'Ортоцентърът е пресечната точка на трите височини на триъгълника. Една от четирите забележителни точки.',
    definitions: [
    ...
    example: {
      ...
      solution: 'В правоъгълен триъгълник двете катети са височини, затова ортоцентърът съвпада с върха при правия ъгъл.'
    },
    mistakes: [
      { label: 'Винаги вътре', text: 'При тъпоъгълен триъгълник ортоцентърът е ИЗВЪН триъгълника.' }
    ],
    miniCheck: [
      {
    ...
    remember: 'Ортоцентър H = пресечна точка на трите височини. При тъпоъгълен — извън триъгълника.'
  },
  ...
  g8t8s5: {
    shortIntro: 'Четириъгълник е вписан, когато всичките му върхове лежат на една окръжност. Признакът: срещуположните ъгли се допълват до 180°.',
    definitions: [
      { term: 'Вписан четириъгълник', def: 'Четириъгълник, чиито върхове лежат на една окръжност.' },
      { term: 'Признак за вписан', def: 'Сборът на срещуположните ъгли е 180°.' }
    ],
    formulas: [
      { label: 'Свойство на вписан четириъгълник', tex: '\\angle A + \\angle C = 180°' },
      { label: 'Втора двойка', tex: '\\angle B + \\angle D = 180°' }
    ],
    drawing: { svg: `<svg viewBox="0 0 280 270" xmlns="http://www.w3.org/2000/svg" style="max-width:280px;">
  <circle cx="140" cy="135" r="100" fill="none" stroke="#4f6ef7" stroke-width="1.8"/>
  <polygon points="60,75 215,95 200,200 70,195" fill="#eef1fe" stroke="#e84393" stroke-width="2"/>
  <circle cx="60" cy="75" r="3" fill="#1a1f2e"/>
  <circle cx="215" cy="95" r="3" fill="#1a1f2e"/>
  <circle cx="200" cy="200" r="3" fill="#1a1f2e"/>
  <circle cx="70" cy="195" r="3" fill="#1a1f2e"/>
  <text x="46" y="72" font-size="13" fill="#64748b">A</text>
  <text x="220" y="92" font-size="13" fill="#64748b">B</text>
  <text x="204" y="216" font-size="13" fill="#64748b">C</text>
  <text x="54" y="210" font-size="13" fill="#64748b">D</text>
  <text x="90" y="250" font-size="11" fill="#4f6ef7" text-anchor="middle">∠A+∠C = 180°</text>
</svg>`, caption: 'Вписан четириъгълник: срещуположните ъгли се допълват до 180°.' },
    algorithm: [
    ...
    remember: 'Вписан четириъгълник: <katex>\\angle A + \\angle C = 180°</katex> (срещуположни ъгли).'
  },

  // --- Описан четириъгълник ---
  g8t8s6: {
    shortIntro: 'Четириъгълник е описан, когато всичките му страни докосват една вписана окръжност. Признакът: сборовете на срещуположните страни са равни.',
    definitions: [
      { term: 'Описан четириъгълник', def: 'Четириъгълник, чиито страни докосват една окръжност (вписана в него).' },
      { term: 'Признак за описан', def: 'Сборовете на срещуположните страни са равни.' }
    ],
    formulas: [
      { label: 'Свойство на описан четириъгълник', tex: 'AB + CD = BC + AD' }
    ],
    drawing: { svg: `<svg viewBox="0 0 280 250" xmlns="http://www.w3.org/2000/svg" style="max-width:280px;">
  <polygon points="40,125 140,40 240,125 140,210" fill="#eef1fe" stroke="#e84393" stroke-width="2"/>
  <circle cx="140" cy="125" r="60" fill="none" stroke="#4f6ef7" stroke-width="1.8"/>
  <circle cx="140" cy="125" r="3" fill="#10b981"/>
  <text x="28" y="130" font-size="13" fill="#64748b">A</text>
  <text x="136" y="34" font-size="13" fill="#64748b">B</text>
  <text x="244" y="130" font-size="13" fill="#64748b">C</text>
  <text x="136" y="228" font-size="13" fill="#64748b">D</text>
  <text x="140" y="245" font-size="11" fill="#4f6ef7" text-anchor="middle">AB+CD = BC+AD</text>
</svg>`, caption: 'Описан четириъгълник: AB + CD = BC + AD.' },
    algorithm: [
